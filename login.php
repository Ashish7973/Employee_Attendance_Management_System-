...
<div class ="container-fluid jumbo_login">
	<div class="wrapper">
		<form action="admin.php" method="post" name="Login_Form" class="form-signin">       
		    <h3 class="form-signin-heading">Welcome Back! Please Sign In</h3>
			  ...
			  <button class="btn btn-lg btn-primary btn-block"  name="logins" value="Logins" type="Submit">Logins</button>  			
		</form>		
	</div>	
</div>
